...
// constructeurs
bigint() : _data("0") {}
bigint(size_t n) : _data(std::to_string(n)) {}
...
bigint operator<<(const bigint &o) const { return *this << (size_t)std::stoull(o._data); }
bigint operator>>(const bigint &o) const { return *this >> (size_t)std::stoull(o._data); }
bigint &operator<<=(const bigint &o) { return *this <<= (size_t)std::stoull(o._data); }
bigint &operator>>=(const bigint &o) { return *this >>= (size_t)std::stoull(o._data); }
